...
const MinorityQuestionnaire = () => {
  ...
  const handleSaveDraft = () => {
    localStorage.setItem('minority_questionnaire_draft', JSON.stringify(formData));
    alert('Draft saved successfully!');
  };

  const handleSubmit = () => {
    console.log('Submitting Minority Investment questionnaire:', formData);
    navigate('/dashboard');
  };
  ...
  const renderStepContent = () => {
    switch (currentStep) {
          ...
          <div className="space-y-6">
            <div>
              ...
              >
                ...
                <option value="buyer_minority">Buyer of minority (or non-controlling majority) interest</option>
                <option value="pipe_investor">PIPE Investor</option>
                <option value="pipe_issuer">PIPE Issuer</option>
                <option value="seller_minority">Seller of minority (or non-controlling majority) interest</option>
              </Select>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {["Cash", "Cash (Contribution)", "Promissory Note", "Stock/Equity", "Warrant"].map((option) => (
                  <label key={option} className="flex items-center space-x-2">
                    <input
                      type="checkbox"
            ...
            <div>
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto border rounded p-2">
                {[...STRUCTURE_OPTIONS, "Note Purchase"].map((option) => (
                  <label key={option} className="flex items-center space-x-2">
                    <input
                      type="checkbox"
      ...
      case 1: // Minority Investment Details
        return (
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <label key={option} className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={formData.targetSecuritiesSold.includes(option)}
                      onChange={() => handleArrayChange('targetSecuritiesSold', option)}
                    />
                    <span className="text-sm">{option}</span>
                  </label>
                ))}
            ...
            <div>
              <Label htmlFor="proceedsGoingTo">Any Proceeds Going to Company?</Label>
              <Select
                id="proceedsGoingTo"
                value={formData.proceedsGoingTo}
                onChange={(e) => handleInputChange('proceedsGoingTo', e.target.value)}
              >
                <option value="">-- Select --</option>
            ...
            <div>
              <Label htmlFor="growthEquity">Growth Equity</Label>
              <Select
                id="growthEquity"
                value={formData.growthEquity}
                onChange={(e) => handleInputChange('growthEquity', e.target.value)}
              >
                <option value="">-- Select --</option>
            ...
            <div>
              <Label>Size of Minority / non-controlling investment</Label>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    id="sizeMin"
                    type="number"
                    value={formData.sizeOfMinorityMin}
                    onChange={(e) => handleInputChange('sizeOfMinorityMin', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    id="sizeMax"
                    type="number"
                    value={formData.sizeOfMinorityMax}
                    onChange={(e) => handleInputChange('sizeOfMinorityMax', e.target.value)}
            ...
            <div>
              <Label htmlFor="ownedInterestBefore">Owned Interest before the purchase?</Label>
              <Select
                id="ownedInterestBefore"
                value={formData.ownedInterestBefore}
                onChange={(e) => handleInputChange('ownedInterestBefore', e.target.value)}
              >
                <option value="">-- Select --</option>
                <option value="yes">Yes</option>
                <option value="no">No</option>
            ...
            <div>
              <Label htmlFor="ownedInterestAfter">Owned Interest after the sale?</Label>
              <Select
                id="ownedInterestAfter"
                value={formData.ownedInterestAfter}
                onChange={(e) => handleInputChange('ownedInterestAfter', e.target.value)}
              >
                <option value="">-- Select --</option>
                <option value="yes">Yes</option>
                <option value="no">No</option>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Minority Investments Questionnaire</h1>
          <p className="mt-2 text-gray-600">Complete the information below for your Minority Investment transaction</p>
        </div>
